...
func (o *Order) MultiFirst(sharding []string) *multiFirst {
	return &multiFirst{
		core:          o,
		unscoped:      o.unscoped,
...
// Tx 设置为事务
func (f *multiFirst) Tx(tx *query.Query) *multiFirst {
	f.tx = tx
	if tx != nil {
		f.qTx = nil
	}
...
// QueryTx 设置为手动事务
func (f *multiFirst) QueryTx(tx *query.QueryTx) *multiFirst {
	f.qTx = tx
	if tx != nil {
		f.tx = nil
	}
