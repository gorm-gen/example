	...
	if u.trace {
		if parent := opentracing.SpanFromContext(ctx); parent != nil {
			if tracer := opentracing.GlobalTracer(); tracer != nil {
				span := tracer.StartSpan("SQL:Order.ShardingUpdate", opentracing.ChildOf(parent.Context()))
				defer span.Finish()
			}
		}
	}
