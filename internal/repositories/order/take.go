...
func (o *Order) MultiTake(sharding []string) *multiTake {
	return &multiTake{
		core:          o,
		unscoped:      o.unscoped,
...
// Tx 设置为事务
func (t *multiTake) Tx(tx *query.Query) *multiTake {
	t.tx = tx
	if tx != nil {
		t.qTx = nil
	}
...
// QueryTx 设置为手动事务
func (t *multiTake) QueryTx(tx *query.QueryTx) *multiTake {
	t.qTx = tx
	if tx != nil {
		t.tx = nil
	}
