...
func (c *_create) Values(values ...*models.IdentityCard) *_create {
...
func (c *_create) Do(ctx context.Context) (err error) {
	...
	if err != nil {
		if repositories.IsRealErr(err) {
			c.core.logger.Error("【IdentityCard.Create】失败", zap.Error(err), zap.ByteString("debug.Stack", debug.Stack()))
		}
		return err
	}
	return nil
