...
const TableNameUserLanguage = "user_language"
...
type UserLanguage struct {
	...
	LanguageID int                   `gorm:"column:language_id;not null;comment:语言ID" json:"language_id"`                                                             // 语言ID
...
// TableName UserLanguage's table name
func (*UserLanguage) TableName() string {
	return TableNameUserLanguage
}
