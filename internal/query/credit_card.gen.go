...
func newCreditCard(db *gorm.DB, opts ...gen.DOOption) creditCard {
	...
	_creditCard.creditCardDo.UseModel(&models.CreditCard{})

	tableName := _creditCard.creditCardDo.TableName()
	_creditCard.ALL = field.NewAsterisk(tableName)
	_creditCard.ID = field.NewInt(tableName, "id")
	_creditCard.Number = field.NewString(tableName, "number")
	_creditCard.UserID = field.NewInt(tableName, "user_id")
...
type ICreditCardDo interface {
	...
	Create(values ...*models.CreditCard) error
	CreateInBatches(values []*models.CreditCard, batchSize int) error
	Save(values ...*models.CreditCard) error
	First() (*models.CreditCard, error)
	Take() (*models.CreditCard, error)
	Last() (*models.CreditCard, error)
	Find() ([]*models.CreditCard, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.CreditCard, err error)
	FindInBatches(result *[]*models.CreditCard, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.CreditCard) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.CreditCard, error)
	FirstOrCreate() (*models.CreditCard, error)
	FindByPage(offset int, limit int) (result []*models.CreditCard, count int64, err error)
...
func (c creditCardDo) Create(values ...*models.CreditCard) error {
	if len(values) == 0 {
		return nil
	}
...
func (c creditCardDo) CreateInBatches(values []*models.CreditCard, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c creditCardDo) Save(values ...*models.CreditCard) error {
	if len(values) == 0 {
		return nil
	}
...
func (c creditCardDo) First() (*models.CreditCard, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.CreditCard), nil
	}
}

func (c creditCardDo) Take() (*models.CreditCard, error) {
...
func (c creditCardDo) Last() (*models.CreditCard, error) {
...
func (c creditCardDo) Find() ([]*models.CreditCard, error) {
	result, err := c.DO.Find()
	return result.([]*models.CreditCard), err
}

func (c creditCardDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.CreditCard, err error) {
	buf := make([]*models.CreditCard, 0, batchSize)
...
func (c creditCardDo) FindInBatches(result *[]*models.CreditCard, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c creditCardDo) FirstOrInit() (*models.CreditCard, error) {
...
func (c creditCardDo) FirstOrCreate() (*models.CreditCard, error) {
...
func (c creditCardDo) FindByPage(offset int, limit int) (result []*models.CreditCard, count int64, err error) {
...
func (c creditCardDo) Delete(models ...*models.CreditCard) (result gen.ResultInfo, err error) {
