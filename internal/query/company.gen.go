...
func newCompany(db *gorm.DB, opts ...gen.DOOption) company {
	...
	_company.companyDo.UseModel(&models.Company{})
...
type ICompanyDo interface {
	...
	Unscoped() ICompanyDo
	Create(values ...*models.Company) error
	CreateInBatches(values []*models.Company, batchSize int) error
	Save(values ...*models.Company) error
	First() (*models.Company, error)
	Take() (*models.Company, error)
	Last() (*models.Company, error)
	Find() ([]*models.Company, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Company, err error)
	FindInBatches(result *[]*models.Company, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Company) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Company, error)
	FirstOrCreate() (*models.Company, error)
	FindByPage(offset int, limit int) (result []*models.Company, count int64, err error)
...
func (c companyDo) Create(values ...*models.Company) error {
	if len(values) == 0 {
		return nil
	}
...
func (c companyDo) CreateInBatches(values []*models.Company, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c companyDo) Save(values ...*models.Company) error {
	if len(values) == 0 {
		return nil
	}
...
func (c companyDo) First() (*models.Company, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Company), nil
	}
}

func (c companyDo) Take() (*models.Company, error) {
...
func (c companyDo) Last() (*models.Company, error) {
...
func (c companyDo) Find() ([]*models.Company, error) {
	result, err := c.DO.Find()
	return result.([]*models.Company), err
}

func (c companyDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Company, err error) {
	buf := make([]*models.Company, 0, batchSize)
...
func (c companyDo) FindInBatches(result *[]*models.Company, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c companyDo) FirstOrInit() (*models.Company, error) {
...
func (c companyDo) FirstOrCreate() (*models.Company, error) {
...
func (c companyDo) FindByPage(offset int, limit int) (result []*models.Company, count int64, err error) {
...
func (c companyDo) Delete(models ...*models.Company) (result gen.ResultInfo, err error) {
